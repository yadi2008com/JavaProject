...
<center>
<%
List<AbsenceBean> absenceBeanList=(List<AbsenceBean>)request.getAttribute("absenceBeanList");
StudentBean studentBean=(StudentBean)request.getAttribute("studentBean");
	...
	if (absenceBeanList != null && !absenceBeanList.isEmpty()) {
%>
              ...
              <td height="470" align="center" valign="top" bgcolor="#F6F9FE"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr align="center"  class="t1">
                    ...
                    <td bgcolor="#D5E4F4"><strong><%=username %></strong></td>
                     <td bgcolor="#D5E4F4"><strong><%=studentBean.getName() %></strong></td>
                    <td bgcolor="#D5E4F4"><strong><%=absenceBean.getNote() %></strong></td>
                    <td bgcolor="#D5E4F4"><strong><%=absenceBean.getTime() %></strong></td>
