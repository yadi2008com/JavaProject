        ...
        <tr>
          ...
          <td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table width="709" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <form name="form1" method="post" action="./BuildingAddServlet" onSubmit="return mycheck()" >
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td><input name="name" type="text" class="text2" id="Building_Name"></td>
                  </tr>
                   <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>楼宇地址：</td>
                    <td><input name="address" type="text" class="text2" id="Building_Name"></td>
                  </tr>
                   <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>楼宇容量：</td>
                    <td><input name="content" type="text" class="text2" id="Building_Name"></td>
                  </tr>
                  <tr>
                    <td height="30">&nbsp;</td>
