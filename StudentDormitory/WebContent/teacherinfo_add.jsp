...
function mycheck(){
   ...
   if(isNull(form1.userpwd.value)){
   alert("请输入密码！");
   return false;
   }
   if(isNull(form1.repassword.value)){
   alert("请输入重复密码！");
   return false;
   }
        ...
        <tr>
          ...
          <td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table width="709" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <form name="form1" method="post" action="./TeacherinfoAddServlet" onSubmit="return mycheck()" >
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td><input name="username" type="text" class="text2" id="Teacher_Username"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>密码：</td>
                    <td><input name="userpwd" type="password" class="text2" id="Teacher_Password"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>重复密码：</td>
                    <td><input name="repassword" type="password" class="text2" id="Teacher_Password2"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>姓名：</td>
                    <td><input name="name" value="<%=request.getAttribute("temp_name")!=null?request.getAttribute("temp_name"):"" %>" type="text" class="text2" id="Teacher_Name"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>联系电话：</td>
                    <td><input name="telephone" type="text" class="text2" id="Teacher_Tel"></td>
                  </tr>
                  <tr>
                    <td height="30">&nbsp;</td>
